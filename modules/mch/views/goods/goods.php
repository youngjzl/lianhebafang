                ...
                <div class="dropdown float-right ml-2">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                        ...
                        <a href="javascript:void(0)" class="btn btn-secondary batch dropdown-item"
                           data-url="<?= $urlManager->createUrl([$urlStr . '/batch']) ?>" data-content="是否批量更新"
                           data-type="99">批量更新</a>
                        <a href="javascript:void(0)" class="btn btn-secondary batch dropdown-item"
                ...
                <tr>
                    ...
                    <td class="nowrap">
                        ...
                        <img src="<?= $imgurl ?>\statics\images\chengxuma.png" width="20px"
                             ...
                             title="小程序码">&nbsp;
						<a class="btn btn-sm btn-primary" href="javascript:" onclick="update(<?= $goods->id ?>);">更新</a>
...
<script>
	...
	function update(id){
    	var url = "<?= $urlManager->createUrl([$urlStr . '/goods-update']) ?>";
        $.ajax({
          url: url,
          type: 'get',
          dataType: 'json',
